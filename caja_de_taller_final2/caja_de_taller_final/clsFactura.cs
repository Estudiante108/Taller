...
namespace caja_de_taller_final
{
    internal class clsFactura
    {
        public class CreaTicket
        {
            ...
            {
                string LineEncavesado = "Descripcion      Cant    Precio    Total";   // agrega lineas de  encabezados---------
            ...
            public void AgregaArticulo(string Articulo, string descripcion, double precio, int cant, double subtotal)
            {
